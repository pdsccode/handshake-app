...
export const URL = {
  ...
  HANDSHAKE_PEX: '/pex',
  HANDSHAKE_GURU: '/guru',
  PEX_EXTENSION: '/guru-extension',
  HANDSHAKE_PEX_CREATOR: '/create-guru',
  HANDSHAKE_PEX_UPDATER: '/create-guru/:eventId?',
  ...
  PEX_INSTRUCTION_URL: '/guru/instructions',
  PEX_LUCKY_DRAW_MECHANIC_URL: '/guru/luckydraw',
