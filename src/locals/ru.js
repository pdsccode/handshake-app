export default {
  ...
  'ex.exchange.status.created': 'Подтверждается...',
  'ex.exchange.status.active': 'Активен',
  'ex.exchange.status.closing': 'В ожидании...',
  'ex.exchange.status.closed': 'Закрыт',
  'ex.exchange.status.shaking': 'Ожидание сделки...',
  'ex.exchange.status.shake': 'Договорились',
  'ex.exchange.status.completing': 'Завершение...',
  'ex.exchange.status.completed': 'Готово',
  'ex.exchange.status.pre_shaking': 'Ожидание сделки',
  'ex.exchange.status.pre_shake': 'Договорились',
  'ex.exchange.status.rejecting': 'Отклоняется',
  'ex.exchange.status.rejected': 'Отклонено',
  'ex.exchange.status.cancelling': 'Отменяется',
  'ex.exchange.status.cancelled': 'Отменено',
  ...
  'ex.shop.shake.status.pre_shaking': 'Запрашивается',
  'ex.shop.shake.status.pre_shake': 'Запрошено',
  'ex.shop.shake.status.shaking': 'Запрашивается',
  'ex.shop.shake.status.shake': 'Запрошено',
