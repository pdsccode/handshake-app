export default {
  ...
  offerHandShakeExchangeContentMe: '{offerType} [{something}] for {amount} {currency} ~ {total} {currency_symbol} ({payment_method})',
  offerHandShakeContentMeDone: '{offerType} {amount} {currency} for {total} {currency_symbol} ({payment_method})',
  offerHandShakeExchangeContentMeDone: '{offerType} [{something}] for {amount} {currency} ~ {total} {currency_symbol} ({payment_method})',
