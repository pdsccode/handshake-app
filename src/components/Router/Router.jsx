...
const Seed = (props) => (<DynamicImport loading={Loading} load={() => import('@/components/Router/Seed')}>{(Component) => <Component {...props} />}</DynamicImport>);
          ...
          <Layout {...this.props}>
            <ScrollToTop>
              <Switch>
                ...
                <Route path={URL.HANDSHAKE_SEED} component={Seed} />
