...
import { setHeaderTitle, setHeaderCanBack, clearHeaderRight } from '@/reducers/app/action';
...
export default connect(null, ({ setHeaderTitle, setHeaderCanBack, clearHeaderRight }))(CreateRouter);
