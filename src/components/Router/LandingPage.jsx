...
const LandingPage = props => (<DynamicImport loading={Loading} load={() => import('@/pages/LandingPage/LandingPage')}>{Component => <Component {...props} />}</DynamicImport>);
...
const routerMap = [
  { path: URL.LANDING_PAGE_SHURIKEN, component: LandingPage },
];
