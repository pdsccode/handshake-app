...
const Withdraw = props => (<DynamicImport loading={Loading} load={() => import('@/pages/Withdraw/Withdraw')}>{Component => <Component {...props} />}</DynamicImport>);
...
class BuyCCRouter extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.setHeaderTitle('Withdraw');
