...
const Admin = props => (<DynamicImport loading={Loading} load={() => import('@/pages/Admin/AdminIDVerification')}>{Component => <Component {...props} />}</DynamicImport>);
...
const routerMap = [
  { path: URL.ADMIN_ID_VERIFICATION, component: Admin },
];

class AdminIDVerificationRouter extends React.Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    this.props.setHeaderTitle('Admin for ID Verification');
