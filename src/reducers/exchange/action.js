...
export const completeShakeOffer = createAPI(EXCHANGE_ACTIONS.COMPLETE_SHAKE_OFFER);

export const cancelShakeOffer = createAPI(EXCHANGE_ACTIONS.CANCEL_SHAKE_OFFER);
