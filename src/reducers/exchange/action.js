...
export const getCryptoPrice = createAPI({
  API: BASE_API.EXCHANGE.GET_CRYPTO_PRICE,
...
export const createCCOrder = createAPI({
  API: BASE_API.EXCHANGE.CREATE_CC_ORDER,
...
export const getUserCcLimit = createAPI({
  API: BASE_API.EXCHANGE.GET_USER_CC_LIMIT,
...
export const getCcLimits = createAPI({
  API: BASE_API.EXCHANGE.GET_CC_LIMITS,
...
export const getUserProfile = createAPI({
  API: BASE_API.EXCHANGE.GET_USER_PROFILE,
...
export const getUserTransaction = createAPI({
  API: BASE_API.EXCHANGE.GET_USER_TRANSACTION,
