...
import DataSetNew from '@/pages/Explore/DataSetNew';
...
class ExploreCreate extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return ( 
        <DataSetNew {...this.props}  token={this.props.auth?.dataset_profile?.token||''}  />
    );
  }
}
...
export default injectIntl(compose(withFirebase, connect(mapState, mapDispatch))(ExploreCreate));
