...
export const call = async function (privateKey, value = 0, method, ...params) {
...
export const send = async function (privateKey, value = 0, method, ...params) {
  var privateProvider = new PrivateKeyProvider(privateKey, network)
  let account = web3.eth.accounts.privateKeyToAccount(privateKey)
  var web3 = new Web3(privateProvider)
  var contract = new web3.eth.Contract(ABI, contractAddress)

  var txPromise = contract.methods
    [method](...params)
...
// fundProject
// ethereumAPI.send(privateKey, amount, 'fundProject', pid)

// withdrawFund
// ethereumAPI.send(privateKey, 0, 'withdrawFund', pid)

// getFundAmount
// ethereumAPI.call(privateKey, 0, 'getFundAmount', pid, funder)

// getWithdrawAmount
// ethereumAPI.call(privateKey, 0, 'getWithdrawAmount', pid, funder)
